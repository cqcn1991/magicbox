# encoding: utf-8
module RESOURCES_CONSTANT
  YOUKU= [{url: 'UMTAyMDY5MTE2', name: 'derren brown', avatar_url: 'http://g4.ykimg.com/0130391F4552D6106FAE4801855CDF59D366E0-9490-7999-097A-157E1B97C94B'},
          {url: 'UMTQ0ODgzOTQ0',name: '张笑我', avatar_url: 'http://g4.ykimg.com/0130391F484C7CBD2F17C40228B03A18B43F30-6A3D-91B1-770E-1A08552BA04C'},
          {url:'UMTg1MzM3MzMy',name: 'E-Chong', avatar_url: 'http://g1.ykimg.com/0130391F45539AC108F00C02C3017DE9463BD1-4352-CC8D-92BF-A238981CCF21'},
          {url: 'UMTQzNDg2NzU2', name: '现实一种', avatar_url: 'http://static.youku.com/user/img/avatar/310/16.jpg'},
          {url: 'UMjUyNDczNTA4', name: '竹音牵梦', avatar_url: 'http://g1.ykimg.com/0130391F454FCF77C8ED5403C31C29A3E9F050-449A-F805-12A9-4A30BDD7C89C?1338996681'},
          {url:'UNDI2NjE2MzI=', name: 'cheunglei', avatar_url: 'http://g4.ykimg.com/0130391F484AE4826F609C00A2BDC0C031F95F-BB2F-E6C0-B121-9D96E1E420FD'},
          {url:'UMjQ4MjgyMjEy', name: '禾小口', avatar_url: 'http://g1.ykimg.com/0130391F455345314C0EA703B31F19B6E3879B-13EA-F53B-4988-96119A1C25D3'},
          {url:'UMTI5MzQyMTQw', name: '哈利波特魔术', avatar_url: 'http://g1.ykimg.com/0130391F484A6D063841E501ED66AF0B651A76-248F-C2D7-375F-1E12635C0C1D'},
          {url:'UNTAwMjg4Njg=', name: 'ArtherChan', avatar_url: 'http://g2.ykimg.com/0130391F45512EBF49269D00BED851CB5A2085-A00B-4B49-3DA3-A89BC359CD4A'},
          #{url:'UMTU1Nzg4MzA0', name: '兰色死鱼', avatar_url: 'http://static.youku.com/user/img/avatar/310/29.jpg'},
          #{url:'UMzY0OTU2ODgw', name: '酒精百分一百二', avatar_url: 'http://static.youku.com/user/img/avatar/310/29.jpg'},
          #{url:'UNTc0MDYxNjcy',name: 'SomethingMagic', avatar_url: 'http://g2.ykimg.com/0130391F455268C22DBFD5088DDF1AED0EAAAB-6D28-F60C-1BAC-BE36197873A7'},
          #{url: 'UMzU5NjcwNzk2',name: 'themagicway', avatar_url: 'http://static.youku.com/user/img/avatar/310/29.jpg'},
          #{url:'UMTg1NTc5ODgw', name: '酒精一百二十度', avatar_url: 'http://static.youku.com/user/img/avatar/310/49.jpg'},
  ]
  FORUMS = [
      {url:'http://tieba.baidu.com/f?kw=%C4%A7%CA%F5', name: '百度魔术吧'},
      {url:'http://www.collegemagic.cn/forum.php', name: '高校魔术'},
      {url:'http://www.superx.org/bbs/forum.php', name: '超人联盟'},
  ...
  YOUTUBE_MAGICIAN_CHANNELS = [
    ...
    # TV Famous Magician: Derren Brown, David Blain, Justin Flom, Yif
    {url:'https://www.youtube.com/channel/UCb9A6uotqUiuVCvVp4GMqOg', name: 'Justin Flom'},
    {url: 'https://www.youtube.com/channel/UCZFjYOyCdMxbt59vZNuqBpw', name: 'Derren Brown'},
    ...
    {url: 'https://www.youtube.com/channel/UCQUECg9e9iqnH_63qM3sj_w', name: 'Looch'},
    {url: 'https://www.youtube.com/channel/UClb3SbmbEKqKSGrBlER8Jgg', name: 'Luca Volpe'},
    {url: 'https://www.youtube.com/channel/UC8Mb-IpQOPBByANch2XGpCg', name: 'Patrick Redford'},
    ...
    {url: 'https://www.youtube.com/channel/UC1PxNSWhJceLOBxdpcDnzsA', name: 'JeanLuc Bertrand'},
